...
class WydarzenieAdmin(admin.ModelAdmin):
        list_display = ['id', 'nazwa', 'data_rozpoczecia', 'data_zakonczenia']

class Wydarzenie_oddzialAdmin(admin.ModelAdmin):
        list_display = ['id', 'oddzial_nazwa', 'wydarzenie_id']

class Rodzaj_biletuAdmin(admin.ModelAdmin):
        list_display = ['id', 'typ', 'czy_z_przewodnikiem', 'cena', 'oddzial_nazwa']
...
class BiletAdmin(admin.ModelAdmin):
        list_display = ['id', 'data_zakupu', 'rodzaj_biletu_id', 'harmonogram_zwiedzania_id']

class DzialAdmin(admin.ModelAdmin):
        list_display = ['id', 'nazwa', 'pietro', 'epoka', 'oddzial_nazwa']
...
class ObrazAdmin(admin.ModelAdmin):
        list_display = ['id', 'nazwa', 'szerokosc', 'wysokosc', 'artysta_id', 'dzial_id']

class RzezbaAdmin(admin.ModelAdmin):
        list_display = ['id', 'nazwa', 'waga', 'material', 'artysta_id', 'dzial_id']
